...
- (void)addScrollView {
    UIButton *addItem=[[UIButton alloc]init];
    addItem.frame=CGRectMake(self.frame.size.width-10, 0,  10,  self.frame.size.height);
    addItem.backgroundColor=[UIColor redColor];
    [addItem setTitle:@"添加" forState:UIControlStateNormal];
...
//    scrollView.backgroundColor = self.bgColor;
    scrollView.backgroundColor =  RGBACOLOR(206, 207, 208, 1);
...
- (void)addItems {
    ...
    float btnW =  (93.0f / 68.0f) * self.scrollView.frame.size.height;
    UIButton *btn = [[UIButton alloc]init];
    [btn setFrame:CGRectMake(self.frame.size.width - btnW, 0, btnW, self.scrollView.frame.size.height)];
//    [btn setTitle:@"+" forState:UIControlStateNormal];
//    [btn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
//    btn.backgroundColor=kBGColor;
    [btn setBackgroundImage:[UIImage imageNamed:@"addItem@2x"] forState:UIControlStateNormal];
...
-(void)showSelectView
{
    ...
    [nav pushViewController:channelVC animated:YES];
}
