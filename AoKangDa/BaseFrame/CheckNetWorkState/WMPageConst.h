...
//  导航菜单栏的背景颜色
#define WMMenuBGColor        [UIColor colorWithRed:206.0/255.0 green:207.0/255.0 blue:208.0/255.0 alpha:1.0]

//  导航菜单栏每个item的宽度
#define WMMenuItemWidth        150*PSDSCALE_X;
//#define WMTitleSizeSelected  KWIDTHShiPei 18.0f;
//#define WMTitleSizeNormal    KWIDTHShiPei  15.0f;
//#define WMMenuHeight         KHEIGHTShiPei 30.0f
//  标题的尺寸(选中/非选中)
