...
#define kTagGap      6250
#define AddButtonWidth    (93.0f / 68.0f) * self.scrollView.frame.size.height
...
- (void)addItems {
    ...
    [btn setFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - AddButtonWidth, 0, AddButtonWidth, self.scrollView.frame.size.height)];
...
- (void)calculateItemFrames {
    ...
    self.scrollView.contentSize = CGSizeMake(contentWidth + AddButtonWidth, self.frame.size.height);
}
