...
#import "TSOneTableViewCellFrame.h"
#import "TSEHomeViewNews.h"
#import "Public.h"
@implementation TSOneTableViewCellFrame
-(void)setOneViewNews:(TSEHomeViewNews *)oneViewNews
{
    oneViewNews = oneViewNews;
